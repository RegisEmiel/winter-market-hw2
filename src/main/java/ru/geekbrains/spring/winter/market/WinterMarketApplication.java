...
public class WinterMarketApplication {
	// К сожалению не успел подготовить домашнее задание к 22.02.2022. Сдаем небольшой, но очень важный проект
	// на работе. Поэтому прошу дать мне еще пару дней, для подготовки, если у Вас будет возможность, не могли бы Вы
	// проверить мою вторую домащнюю работу 24.02.2022.
	//
	// Домашнее задание:
